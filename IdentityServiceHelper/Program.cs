using IdentityServiceHelper.Example.Endpoints;
using IdentityServiceHelper.Example.Services;
using IdentityServiceHelper.Utils;
using IdentityServiceHelper.Utils.Http;
using IdentityServiceHelper.Utils.Mongo;
using FluentValidation;
using System.Diagnostics.CodeAnalysis;
using IdentityServiceHelper.Config;
using IdentityServiceHelper.Utils.Logging;
using Serilog;
