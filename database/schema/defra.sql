...
-- changeset gary:1769767521213-1 splitStatements:true
CREATE TABLE "application" ("id" UUID DEFAULT public.uuid_generate_v4() NOT NULL, "name" TEXT NOT NULL, "client_id" UUID NOT NULL, "tenant_name" TEXT NOT NULL, "description" TEXT NOT NULL, "status_type_id" SMALLINT DEFAULT 1 NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT NOW() NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE, "is_deleted" BOOLEAN DEFAULT FALSE NOT NULL, CONSTRAINT "PK_application" PRIMARY KEY ("id"));
...
-- changeset gary:1769767521213-2 splitStatements:false
...
-- changeset gary:1769767521213-3 splitStatements:false
CREATE TABLE "county_parish_holding" ("id" UUID DEFAULT public.uuid_generate_v4() NOT NULL, "identifier" VARCHAR NOT NULL, "status_type_id" SMALLINT DEFAULT 1 NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT NOW() NOT NULL, "created_by" UUID NOT NULL, "processed_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_by" UUID, "updated_at" TIMESTAMP WITH TIME ZONE, "is_deleted" BOOLEAN DEFAULT FALSE NOT NULL, CONSTRAINT "PK_county_parish_holding" PRIMARY KEY ("id"));

-- changeset gary:1769767521213-4 splitStatements:false
CREATE TABLE "delegation" ("id" UUID DEFAULT public.uuid_generate_v4() NOT NULL, "status_type_id" SMALLINT DEFAULT 1 NOT NULL, "county_parish_holding_id" UUID NOT NULL, "application_id" UUID NOT NULL, "invited_by_user_id" UUID NOT NULL, "invited_by_role_id" SMALLINT NOT NULL, "invited_user_id" UUID NOT NULL, "invited_email" VARCHAR NOT NULL, "invitation_token" CHAR(64) NOT NULL, "token_expires_at" CHAR(1) NOT NULL, "delegated_role_id" SMALLINT NOT NULL, "delegated_permissions" JSONB NOT NULL, "invited_at" TIMESTAMP WITH TIME ZONE NOT NULL, "activated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "registered_at" TIMESTAMP WITH TIME ZONE NOT NULL, "revoked_at" TIMESTAMP WITH TIME ZONE NOT NULL, "ActivatedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "expired_at" TIMESTAMP WITH TIME ZONE NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT NOW() NOT NULL, "created_by" UUID NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE, "is_deleted" BOOLEAN DEFAULT FALSE NOT NULL, CONSTRAINT "PK_delegation" PRIMARY KEY ("id"));

-- changeset gary:1769767521213-5 splitStatements:false
CREATE TABLE "federation" ("id" UUID DEFAULT public.uuid_generate_v4() NOT NULL, "user_account_id" UUID NOT NULL, "tenant_name" TEXT NOT NULL, "object_id" UUID NOT NULL, "trust_level" TEXT DEFAULT 'standard' NOT NULL, "sync_status" TEXT DEFAULT 'linked' NOT NULL, "last_synced_at" TIMESTAMP WITH TIME ZONE NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT NOW() NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE, "is_deleted" BOOLEAN DEFAULT FALSE NOT NULL, CONSTRAINT "PK_federation" PRIMARY KEY ("id"));

-- changeset gary:1769767521213-6 splitStatements:false
CREATE TABLE "krds_sync_log" ("id" UUID NOT NULL, "correlation_id" UUID NOT NULL, "source_endpoint" TEXT NOT NULL, "http_status" INTEGER NOT NULL, "processed_ok" BOOLEAN NOT NULL, "message" TEXT NOT NULL, "received_at" TIMESTAMP WITH TIME ZONE DEFAULT NOW() NOT NULL, "processed_at" TIMESTAMP WITH TIME ZONE NOT NULL, "is_deleted" BOOLEAN DEFAULT FALSE NOT NULL, CONSTRAINT "PK_krds_sync_log" PRIMARY KEY ("id"));

-- changeset gary:1769767521213-7 splitStatements:false
CREATE TABLE "registration" ("id" UUID DEFAULT public.uuid_generate_v4() NOT NULL, "country_parish_holding_id" UUID NOT NULL, "application_id" UUID NOT NULL, "status_type_id" SMALLINT DEFAULT 1 NOT NULL, "enrolled_at" TIMESTAMP WITH TIME ZONE DEFAULT NOW() NOT NULL, "expires_at" TIMESTAMP WITH TIME ZONE DEFAULT NOW() NOT NULL, "created_by" UUID NOT NULL, "updated_by" UUID, "created_at" TIMESTAMP WITH TIME ZONE DEFAULT NOW() NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE, "is_deleted" BOOLEAN DEFAULT FALSE NOT NULL, CONSTRAINT "PK_registration" PRIMARY KEY ("id"));

-- changeset gary:1769767521213-8 splitStatements:false
...
-- changeset gary:1769767521213-9 splitStatements:false
...
-- changeset gary:1769767521213-33 splitStatements:false
...
-- changeset gary:1769767521213-34 splitStatements:false
...
-- changeset gary:1769767521213-35 splitStatements:false
...
-- changeset gary:1769767521213-36 splitStatements:false
...
-- changeset gary:1769767521213-37 splitStatements:false
...
-- changeset gary:1769767521213-38 splitStatements:false
...
-- changeset gary:1769767521213-39 splitStatements:false
...
-- changeset gary:1769767521213-40 splitStatements:false
...
-- changeset gary:1769767521213-41 splitStatements:false
...
-- changeset gary:1769767521213-42 splitStatements:false
...
-- changeset gary:1769767521213-43 splitStatements:false
...
-- changeset gary:1769767521213-44 splitStatements:false
...
-- changeset gary:1769767521213-45 splitStatements:false
...
-- changeset gary:1769767521213-46 splitStatements:false
...
-- changeset gary:1769767521213-47 splitStatements:false
...
-- changeset gary:1769767521213-48 splitStatements:false
...
-- changeset gary:1769767521213-49 splitStatements:false
