...
{
    [LoggerMessage(LogLevel.Information, "Getting list of assignments for county parish holding")]
    partial void LogGettingListOfAssignmentsForCountyParishHolding();
}
