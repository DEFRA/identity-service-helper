// <copyright file="DeleteStrategyBuilder.logger.cs" company="Defra">
...
public partial class DeleteStrategyBuilder<TService, TEntity>
{
    ...
    static partial void LogSuccessfullyExecutedActionEntityWithIdIdByOperatorId(ILogger<TService> logger, string actionDescription, string entityDescription, Guid id, Guid operatorId);
}
