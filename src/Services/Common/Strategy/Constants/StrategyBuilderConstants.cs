...
namespace Defra.Identity.Services.Common.Strategy.Constants;
...
public static class StrategyBuilderConstants
{
    public static class Errors
    {
        ...
        public const string OperatorContextOperatorIdRequired = "Operator id must be provided for this operation";
