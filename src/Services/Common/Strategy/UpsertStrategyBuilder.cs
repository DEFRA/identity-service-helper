    ...
    where TEntity : class
{
    ...
    public UpsertStrategyBuilder<TService, TEntity> WithExistenceRules(
    ...
    public UpsertStrategyBuilder<TService, TEntity> WithConflictRules(
    ...
    public UpsertStrategyBuilder<TService, TEntity> WithBusinessRules(
