...
client.test("Should get invalid API Key payload", function () {
    ...
    client.assert(jsonData.error.code === "Invalid Api Key", "Error code is not 'Invalid header'");
    client.assert(jsonData.error.message === "Header x-api-key is not valid.", "Error message is incorrect");
