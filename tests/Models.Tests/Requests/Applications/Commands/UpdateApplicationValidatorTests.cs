// <copyright file="UpdateApplicationValidatorTests.cs" company="Defra">
...
public class UpdateApplicationValidatorTests
{
    private readonly UpdateApplicationValidator validator = new();
    ...
    private static UpdateApplicationByClientId CreateValidRequest() =>
        new()
        {
            Id = Guid.NewGuid(),
            Name = "New App",
